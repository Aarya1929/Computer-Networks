...
public class OSPF {
    static class Graph {
        private final Map<Integer, Map<Integer, Integer>> adjacencyList; //connectivity between routers(neighbors and link costs)
        private final Map<Integer, Map<Integer, String>> networkAddresses; //network addresses between routers
        ...
        //adds an edge between two routers 
        ...
        //simulates sending hello packets between routers
...
//                }
        ...
        //Dijkstra's algo. to find shortest path
        ...
        //display all the network addresses between routers
        ...
        //returns shortest ppath from source to destination
        ...
        //Routing table for a specific router
        public void printRoutingTable(int routerId) {
            ...
            System.out.printf("%-20s %-10s %-15s\n", "Network Address", "Cost", "Next Router");
            System.out.println("-------------------------------------------------------");
